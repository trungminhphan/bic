	...
	<div class="col-md-12">
		<div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-gears"></i> Danh sách Khóa học</h4>
            </div>
            <div class="panel-body">
            <a href="themkhoahoc.html" class="btn btn-primary m-b-10" id="themmoi"><i class="fa fa-plus"></i> Thêm mới</a>
            <table id="data-table" class="table table-striped table-bordered table-hovered">
                ...
                if($list){
                	...
                	foreach ($list as $ds) {
                		...
                		echo '<td class="text-center"><a href="themkhoahoc.html?id='.$ds['_id'].'&act=del" onclick="return confirm(\'Chắc chắn muốn xóa?\')"><i class="fa fa-trash"></i></a></td>';
                        echo '<td class="text-center"><a href="themkhoahoc.html?id='.$ds['_id'].'&act=edit"><i class="fa fa-pencil"></i></a></td>';
                		echo '</tr>';$i++;
                	}
                }
                ?>
