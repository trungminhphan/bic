...
class GocHocTap {
	...
	public function __construct(){
		...
		$this->_collection = $this->_mongo->getCollection(gochoctap::COLLECTION);
	}
	...
	public function get_list_to_parent(){
		$query = array('id_danhmucgochoctap' => $this->id_danhmucgochoctap);
		return $this->_collection->find($query)->limit(20)->sort(array('orders' => 1, 'date_post'=>-1));	
	}

	public function get_gochoctapmoi(){
	...
	public function get_list_home($dmtt){
		$query = array('id_danhmucgochoctap' => $dmtt, 'hienthi' => 1);
