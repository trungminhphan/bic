...
if($id && $act == 'edit'){
    $khoahoc->id = $id; $t = $khoahoc->get_one();
    $id_danhmuckhoahoc = $t['id_danhmuckhoahoc'];
    $tieude = $t['tieude'];
    $mota = $t['mota'];
    $noidung = $t['noidung'];
    $hinhanh = $t['hinhanh'];
...
<link href="assets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" />
<link href="assets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" />
<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="form-horizontal" data-parsley-validate="true" name="bannerform" id="khoahocform" enctype="multipart/form-data">
<div class="row">
	<div class="col-md-12">
